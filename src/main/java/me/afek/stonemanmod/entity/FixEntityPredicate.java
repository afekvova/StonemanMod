...
public class FixEntityPredicate {
    public static final FixEntityPredicate DEFAULT = new FixEntityPredicate();
    ...
    public FixEntityPredicate range(double p_221013_1_) {
        this.range = p_221013_1_;
        return this;
    }

    public FixEntityPredicate allowInvulnerable() {
        this.allowInvulnerable = true;
        return this;
    }

    public FixEntityPredicate allowSameTeam() {
        this.allowSameTeam = true;
        return this;
    }

    public FixEntityPredicate allowUnseeable() {
        this.allowUnseeable = true;
        return this;
    }

    public FixEntityPredicate allowNonAttackable() {
        this.allowNonAttackable = true;
        return this;
    }

    public FixEntityPredicate ignoreInvisibilityTesting() {
        this.testInvisible = false;
        return this;
    }

    public FixEntityPredicate selector(@Nullable Predicate<LivingEntity> p_221012_1_) {
